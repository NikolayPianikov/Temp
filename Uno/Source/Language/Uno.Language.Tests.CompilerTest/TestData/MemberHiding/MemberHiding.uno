namespace foo
{
    ...
    public class Derived : Base
    {
        ...
        public int this[int index] { get { return 0; } } // $W [Ignore] Indexer with same parameter type $W 'foo.Derived[int]' hides inherited member 'foo.Base[int]' -- use 'new' modifier if hiding is intentional
